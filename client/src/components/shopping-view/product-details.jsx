  ...
  function handleAddReview() {
    dispatch(
      ...
      if (data.success==true) {
        ...
        // Check for the error message and show it
        const errorMessage = data.message || "You need to purchase product to review it";
        toast({
          title: errorMessage,
          variant: "destructive", // Optional: change to 'destructive' if you want a different style for error messages
        });
      }
    });
  }
