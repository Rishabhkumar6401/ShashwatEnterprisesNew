...
export const addNewProduct = createAsyncThunk(
  ...
  async (formData) => {
    const result = await axios.post(
      "https://chatorzzz.in/api/admin/products/add",
      formData,
      {
        headers: {
...
export const fetchAllProducts = createAsyncThunk(
  ...
  async ({ page = 1, limit = 10 }) => { // Accept page and limit as parameters
    const result = await axios.get(
      `https://chatorzzz.in/api/admin/products/get?page=${page}&limit=${limit}`
    );
...
export const fetchOutOfStockProducts = createAsyncThunk(
  ...
  async () => {
    const result = await axios.get(
      "https://chatorzzz.in/api/admin/products/outOfStock"
    );
...
export const editProduct = createAsyncThunk(
  ...
  async ({ id, formData }) => {
    const result = await axios.put(
      `https://chatorzzz.in/api/admin/products/edit/${id}`,
      formData,
      {
        headers: {
          "Content-Type": "application/json",
...
export const deleteProduct = createAsyncThunk(
  ...
  async (id) => {
    const result = await axios.delete(
      `https://chatorzzz.in/api/admin/products/delete/${id}`
    );
