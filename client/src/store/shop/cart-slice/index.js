...
export const addToCart = createAsyncThunk(
  ...
  async ({ userId, productId, quantity }) => {
    const response = await axios.post(
      "https://chatorzzz.in/api/shop/cart/add",
      {
        userId,
        productId,
        quantity,
...
export const fetchCartItems = createAsyncThunk(
  ...
  async (userId) => {
    const response = await axios.get(
      `https://chatorzzz.in/api/shop/cart/get/${userId}`
    );
    return response.data;
  }
);
...
export const deleteCartItem = createAsyncThunk(
  ...
  async ({ userId, productId }) => {
    const response = await axios.delete(
      `https://chatorzzz.in/api/shop/cart/${userId}/${productId}`
    );
    return response.data;
  }
);
...
export const updateCartQuantity = createAsyncThunk(
  ...
  async ({ userId, productId, quantity }) => {
    const response = await axios.put(
      "https://chatorzzz.in/api/shop/cart/update-cart",
      {
        userId,
        productId,
        quantity,
...
export const clearCartFromDB = createAsyncThunk(
  ...
  async (userId) => {
    await axios.delete(`https://chatorzzz.in/api/shop/cart/${userId}`);
