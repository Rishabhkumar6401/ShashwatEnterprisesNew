...
export const fetchUsers = createAsyncThunk(
    "salesman/fetchUsers",
    async () => {
        const response = await axios.get("https://chatorzzz.in/api/salesman/users", {
...
export const addUser = createAsyncThunk(
    "salesman/addUser",
    async (userData) => {
        const response = await axios.post("https://chatorzzz.in/api/salesman/users", userData, {
            withCredentials: true,
        });
        return response.data;
    }
...
//     async (userId) => {
//         const response = await axios.post(`https://chatorzzz.in/api/salesman/impersonate/${userId}`, {}, {
//             withCredentials: true,
//         });
//         return response.data;
//     }
...
export const fetchSalesmen = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get("https://chatorzzz.in/api/salesman", {
            withCredentials: true,
        });
...
export const fetchSalesmenOrders = createAsyncThunk(
    ...
    async (salesmanId) => {
        const response = await axios.get(`https://chatorzzz.in/api/salesman/orders/${salesmanId}`, {
            withCredentials: true,
        });
